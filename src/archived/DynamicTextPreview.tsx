...
import { NarrativeSection, Field, DynamicField, ExpansionField } from './narrative';
...
import { DATA_SOURCES_SCHEMA, CLINICAL_DOMAIN_OPTIONS, DATA_FORMAT_OPTIONS, DATA_VOLUME_OPTIONS, IDENTIFIABILITY_LEVEL_OPTIONS, SECURITY_MEASURES_OPTIONS, SENSITIVE_CATEGORIES_OPTIONS, CLINICAL_SETTING_OPTIONS, EXPANSION_MAPPINGS, EXPANSION_FIELDS } from './irbNarrativeSchema';
